...
const deleteExtensionFile = (fileName) => {
    return fileName.split(".").shift() || "";
};
const routerDinamic = () => __awaiter(void 0, void 0, void 0, function* () {
    const files = fs_1.default.readdirSync(path).filter((file) => {
        const fileOmitExtension = deleteExtensionFile(file);
        const verfyFileNameOmitIndex = ["index"].includes(fileOmitExtension);
